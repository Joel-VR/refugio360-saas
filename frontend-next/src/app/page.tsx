  ...
  return (
    <PublicShell>
      ...
      <section className='relative h-[300px] md:h-[500px] w-full'>
        <Image src='/77.png' alt='Refugio360' fill priority className='object-cover object-center' sizes='100vw' />
      ...
      <section className='mx-auto grid max-w-6xl gap-10 px-4 md:px-6 pt-4 pb-10 md:pt-6 md:pb-14'>
        <div className='grid gap-5'>
          <h1 className='max-w-3xl text-3xl md:text-5xl font-semibold tracking-tight'>¡Bienvenido a Refugio360!</h1>
          <p className='max-w-2xl text-base leading-7 text-slate-custom-700'>
            Explora nuestros refugios aliados, conoce a los peluditos en adopción y mira el impacto real de cada ayuda.
            Si deseas adoptar, publicar un caso o realizar una donación, solo necesitas crear tu cuenta en un par de
            clics. ¡Empecemos juntos a cambiar sus vidas!
          </p>
          <div className='flex flex-wrap gap-3 pt-2'>
            <Link
              href='/refugios'
              className='rounded-full bg-brand-600 px-6 py-3 text-sm font-semibold text-white shadow-sm shadow-brand-600/30 transition hover:bg-brand-700 hover:shadow-md'
            >
              Ver refugios
            </Link>
            <Link
              href='/donar'
              className='rounded-full border border-brand-600 px-6 py-3 text-sm font-semibold text-brand-600 transition hover:bg-cream-50'
            >
              Quiero donar
            </Link>
          </div>
            ...
            {[
              {
                ...
                body: 'Mira refugios, animales disponibles y la transparencia de donaciones, sin registrarte.',
              },
              {
                step: '2',
                title: 'Regístrate según tu perfil',
                body: 'Elige Persona natural para adoptar o donar, o Albergue si representas una organización.',
              },
              {
                step: '3',
                title: 'Dona, adopta o publica',
                body: 'Con tu cuenta ya puedes donar, solicitar una adopción o publicar mascotas perdidas/encontradas.',
              },
            ].map(item => (
        ...
        <div className='grid gap-6 md:grid-cols-2'>
          ...
          <article className='relative overflow-hidden rounded-2xl border border-slate-custom-50 bg-white p-8'>
            ...
            <p className='mt-3 text-sm leading-7 text-slate-custom-700'>
              ...
              comenzando en nuestra ciudad y con la posibilidad de expandirnos a más ciudades y albergues en el futuro,
              sin perder la transparencia ni la cercanía con la comunidad.
            </p>
          </article>
        </div>
          ...
          <div className='mt-5 grid gap-4 sm:grid-cols-2'>
            <div className='rounded-lg border border-slate-custom-50 bg-cream-50 p-4'>
              ...
              <div className='mt-3 grid gap-3'>
                {[
                  { name: 'Joel Augusto Vilca Rosas', email: '2021210350@udh.edu.pe', phone: '+51 926 242 955' },
                  {
                    name: 'Jorge Luis Salazar Tarazona',
                    email: '2022110489@udh.edu.pe',
                    phone: '+51 947 802 314',
                  },
                  {
                    name: 'Ericsson Junior Huancaya Recines',
                    email: '2022110480@udh.edu.pe',
                    phone: '+51 918 573 942',
                  },
                  {
                    name: 'Yhozira Milagros Dueñas Loyola',
                    email: '2022110530@udh.edu.pe',
                    phone: '+51 956 240 178',
                  },
                ].map(dev => (
                  <div
                    key={dev.name}
                    className='flex items-start gap-3 rounded-lg border border-slate-custom-50 bg-white px-3 py-2.5'
                  >
