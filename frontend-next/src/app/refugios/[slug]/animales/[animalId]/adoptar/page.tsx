  ...
  return (
    <RoleGate allow={["natural_person"]}>
      <SimplePage title="Solicitud de adopción" description={`Formulario simple para solicitar adopción del animal #${animalId}.`}>
        <form className="grid max-w-lg gap-3 rounded-lg border border-slate-200 bg-white p-5">
          ...
          <button className="rounded-md bg-teal-700 px-4 py-2 text-sm font-semibold text-white">Enviar solicitud</button>
        </form>
      </SimplePage>
    </RoleGate>
  );
